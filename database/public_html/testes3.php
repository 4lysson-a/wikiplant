...
<body>
  ...
  <div id="df">
    ...
    <center>
      <span onclick="openca()"><img id="user" src="img/icon/user.png"></span>
      <a href="www.facebook.com/wikiplant" target="_blank"><img id="facebook" src="img/icon/focebook.png"></a>
      <a href="mailto:wikiplant@gmail.com"><img id="mail" src="img/icon/email.png"></a>
      <a href="tel:+5512981025957"><img id="tel" src="img/icon/tell.png" alt=""></a>
    </center>
  ...
  <section id="conta">
    ...
    <section id="alas-perfilmachine">
      <section id="respostaaddform" style="width: 0%;">
        <div id="textorespostaaddform" style="display: none;">
          <br />
          <b>Notice</b>: Undefined variable: textrespos in <b>/opt/lampp/htdocs/publichtml/conta.php</b> on line <b>76</b><br />
        </div>
      </section>
      ...
      <samp onclick='subala1()'>
        <div class='subala'>
          <h4>oi1</h4>
        </div>
      </samp>
      <samp onclick='subala2()'>
        <div class='subala'>
          <h4>ta bao2</h4>
        </div>
      </samp>
      <samp onclick='subala3()'>
        <div class='subala'>
          <h4>mano3</h4>
        </div>
      </samp>
    ...
    <section>
      <form id="info-perfilmachine" action="teste.php" method="post">
        ...
        <div class='info' id='cala1' style='display: none;'>
          <h1>se � loco<a href='javascript:void(0)' class='closebtn' onclick=clala1()>&times;</a></h1>
        </div>
        <div class='info' id='csubala1' style='display: none;'>
          <h2>1oi<a href='javascript:void(0)' class='closebtn' onclick=clsubala1()>&times;</a></h2>
        ...
        <div class='info' id='csubala2' style='display: none;'>
          <h2>2ta bao<a href='javascript:void(0)' class='closebtn' onclick=clsubala2()>&times;</a></h2>
        </div>
        <div class='info' id='csubala3' style='display: none;'>
          <h2>3mano<a href='javascript:void(0)' class='closebtn' onclick=clsubala3()>&times;</a></h2>
        </div>
        <div class='info' id='cala2' style='display: none;'>
          <h1>oi ta de boa<a href='javascript:void(0)' class='closebtn' onclick=clala2()>&times;</a></h1>
        </div>
      </form>
    </section>
  </section>
  ...
  <script>
    ...
    function ala1() {
      document.getElementById("cala1").style.display = 'inherit';
    }

    function ala2() {
      document.getElementById("cala2").style.display = 'inherit';
    }

    function clala1() {
      document.getElementById("cala1").style.display = 'none';
    }

    function clala2() {
      document.getElementById("cala2").style.display = 'none';
    }

    function subala1() {
      document.getElementById("csubala1").style.display = 'inherit';
    }

    function subala2() {
      document.getElementById("csubala2").style.display = 'inherit';
    }

    function subala3() {
      document.getElementById("csubala3").style.display = 'inherit';
    }

    function clsubala1() {
      document.getElementById("csubala1").style.display = 'none';
    }

    function clsubala2() {
      document.getElementById("csubala2").style.display = 'none';
    }

    function clsubala3() {
      document.getElementById("csubala3").style.display = 'none';
    }
  </script>