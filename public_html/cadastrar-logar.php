  ...
  <section>
    <div id="df3">
      <div class="doisformis">
        <?php
          include 'conexao.php';
          $con = mysqli_connect($host, $user, $pass, "contas");if (!$con){echo "<h1>Erro!!!</h1>";}
          $respos = ""; $apas = '"'; $resposnome = ""; $resposemail = ""; $respossenha = "";
          $resposLOG = ""; $resposemailLOG = ""; $respossenhaLOG = "";
          ...
          if (isset($_POST["logar"])){
            if(!empty($_POST["emailLOG"]) && !empty($_POST["senhaLOG"])){
              $email = $_POST["emailLOG"]; $_SESSION['email'] = $email;
              $senha = $_POST["senhaLOG"]; $_SESSION['senha'] = $senha;
